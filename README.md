...
R package **piamInterfaces**, version **0.35.5**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.35.5, <https://github.com/pik-piam/piamInterfaces>.
